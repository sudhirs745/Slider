...
public class ThinWormAnimation extends WormAnimation {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ThinWormAnimation duration(long duration) {
    ...
    public WormAnimation with(int coordinateStart, int coordinateEnd, int radius, boolean isRightSide) {
        if (hasChanges(coordinateStart, coordinateEnd, radius, isRightSide)) {
            ...
            WormAnimation.RectValues rec = createRectValues(isRightSide);
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ThinWormAnimation progress(float progress) {
        if (animator != null) {

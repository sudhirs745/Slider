...
import com.bassbosster.slider.autoimageslider.IndicatorView.animation.data.type.SlideAnimationValue;
...
public class SlideAnimation extends BaseAnimation<ValueAnimator> {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.SlideAnimation progress(float progress) {
        if (animator != null) {
    ...
    @NonNull
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.SlideAnimation with(int coordinateStart, int coordinateEnd) {

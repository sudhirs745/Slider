...
public class WormAnimation extends BaseAnimation<AnimatorSet> {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.WormAnimation duration(long duration) {
        super.duration(duration);
        return this;
    }

    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.WormAnimation with(int coordinateStart, int coordinateEnd, int radius, boolean isRightSide) {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.WormAnimation progress(float progress) {
        if (animator == null) {
            return this;
        }

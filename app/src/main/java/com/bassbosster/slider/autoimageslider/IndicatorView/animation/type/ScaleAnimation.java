...
public class ScaleAnimation extends ColorAnimation {
    ...
    @NonNull
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ScaleAnimation with(int colorStart, int colorEnd, int radius, float scaleFactor) {

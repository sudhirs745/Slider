package com.bassbosster.slider.autoimageslider;
...
import com.bassbosster.slider.PageCountInterface;
import com.bassbosster.slider.R;
import com.bassbosster.slider.autoimageslider.CircularSliderHandle;
import com.bassbosster.slider.autoimageslider.IndicatorAnimations;
import com.bassbosster.slider.autoimageslider.IndicatorView.PageIndicatorView;
import com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.AnimationType;
import com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.BaseAnimation;
import com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ColorAnimation;
import com.bassbosster.slider.autoimageslider.IndicatorView.draw.controller.DrawController;
import com.bassbosster.slider.autoimageslider.IndicatorView.draw.data.Orientation;
import com.bassbosster.slider.autoimageslider.IndicatorView.draw.data.RtlMode;
import com.bassbosster.slider.autoimageslider.IndicatorView.utils.DensityUtils;
import com.bassbosster.slider.autoimageslider.SliderAnimations;
import com.bassbosster.slider.autoimageslider.SliderPager;
import com.bassbosster.slider.autoimageslider.Transformations.AntiClockSpinTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.Clock_SpinTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeInDepthTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeInRotationTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeInScalingTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeOutDepthTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeOutRotationTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.CubeOutScalingTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.DepthTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.FadeTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.FanTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.FidgetSpinTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.GateTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.HingeTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.HorizontalFlipTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.PopTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.SimpleTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.SpinnerTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.TossTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.VerticalFlipTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.VerticalShutTransformation;
import com.bassbosster.slider.autoimageslider.Transformations.ZoomOutTransformation;

import static com.bassbosster.slider.autoimageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;

public class SliderView extends FrameLayout {

    PageCountInterface pageCountInterface;
...
//        }
    ...
    public void startAutoCycle(final PageCountInterface  pageCountInterface) {
                ...
                try {
                    ...
                    if (mAutoCycleDirection == AUTO_CYCLE_DIRECTION_BACK_AND_FORTH) {
                        if (currentPosition == 0) {
                            ...
                            pageCountInterface.pageCount(currentPosition,true);
                        }

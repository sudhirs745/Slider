...
public class SwapAnimation extends BaseAnimation<ValueAnimator> {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.SwapAnimation progress(float progress) {
        if (animator != null) {
    ...
    @NonNull
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.SwapAnimation with(int coordinateStart, int coordinateEnd) {

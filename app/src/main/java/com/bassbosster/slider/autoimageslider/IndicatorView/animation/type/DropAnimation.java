package com.bassbosster.slider.autoimageslider.IndicatorView.animation.type;
...
import com.bassbosster.slider.autoimageslider.IndicatorView.animation.data.type.DropAnimationValue;
...
public class DropAnimation extends BaseAnimation<AnimatorSet> {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.DropAnimation progress(float progress) {
        if (animator != null) {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.DropAnimation duration(long duration) {
        super.duration(duration);
        return this;
    }

    @SuppressWarnings("UnnecessaryLocalVariable")
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.DropAnimation with(int widthStart, int widthEnd, int heightStart, int heightEnd, int radius) {

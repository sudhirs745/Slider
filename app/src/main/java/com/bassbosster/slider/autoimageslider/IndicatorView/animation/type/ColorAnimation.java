...
public class ColorAnimation extends BaseAnimation<ValueAnimator> {
    ...
    @Override
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ColorAnimation progress(float progress) {
        if (animator != null) {
    ...
    @NonNull
    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.ColorAnimation with(int colorStart, int colorEnd) {

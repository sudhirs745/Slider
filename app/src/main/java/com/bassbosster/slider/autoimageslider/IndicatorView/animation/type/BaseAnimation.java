...
public abstract class BaseAnimation<T extends Animator> {
    ...
    public abstract com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.BaseAnimation progress(float progress);

    public com.bassbosster.slider.autoimageslider.IndicatorView.animation.type.BaseAnimation duration(long duration) {
